...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Hi chào cậu tớ đứng đây từ chiều " ;
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Nắng quá cho vào nhà đi sắp cháy da dồi';
document.querySelector('.Description .modal-body').innerHTML = 'Ấn close đi xong ấn vào phần chữ đi </i> ';
